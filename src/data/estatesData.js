export const ESTATES_DATA = [
  {
    ...
    price: "₦2,400,000 - ₦7,200,000",
    numericPrice: 2400000,
    title: "Registered Survey",
    verificationBadge: "Registered Survey",
    plotSize: "300 SQM & 500 SQM",
    paymentPlan: "Outright (1-3 Mos), 6 Mos & 12 Mos Plans",
    initialDeposit: "Flexible Monthly Installments",
    status: "Selling Fast",
    featured: true,
...
Zenith Gardens, Magboro. Own your ground. Build your future. Grow with the city.`,
    infrastructure: [
      ...
      "Instant Physical Allocation & Immediate Survey Pegging",
      "100% Motorable Access Road to Estate"
    ],
    faqs: [
      {
        question: "Where is Zenith Gardens located?",
        answer: "Zenith Gardens is located in Shote Community, Magboro of Owode LCDA, Ogun State — just a 15-minute drive from Alausa, Ikeja."
      },
      {
        question: "What type of title does Zenith Gardens have on the land?",
        answer: "Zenith Gardens holds a Registered Survey title."
      },
      {
        question: "What infrastructure will the developer provide?",
        answer: "The developer will provide perimeter fencing, earth access roads, and a secure gated entry house."
      },
      {
        question: "What are the survey and documentation fees?",
        answer: "Survey fee is ₦500,000 for 1 plot, ₦800,000 for 2-3 plots, and ₦1,100,000 for 4-6 plots. Agreement and documentation fee is ₦500,000 per plot."
      },
      {
        question: "When will my plot(s) be allocated to me?",
        answer: "Immediately after 100% land payment, land agreement documentation, survey fee, and development levy are processed."
      },
      {
  ...
  },
  {
    ...
    title: "Excision",
    verificationBadge: "Excision Title",
    plotSize: "300 SQM & 500 SQM",
    paymentPlan: "Outright (1-3 Mos), 6 Mos & 12 Mos Plans",
    initialDeposit: "Flexible Monthly Installments",
    status: "Selling Fast",
    ...
    pricingGrid: [
      {
        size: "500 SQM",
        outright: "₦10,000,000",
        sixMonths: "₦14,000,000",
        twelveMonths: "₦18,000,000"
      },
      {
        size: "300 SQM",
        outright: "₦6,000,000",
...
Iloshe Gardens, Abule Pan. Own today. Grow with tomorrow.`,
  ...
  },
  {
    ...
    verificationBadge: "Government Allocation",
    plotSize: "300 SQM & 500 SQM",
    paymentPlan: "Outright (1-3 Mos), 6 Mos & 12 Mos Plans",
    initialDeposit: "Flexible Monthly Installments",
    status: "High Value Zone",
    featured: true,
    ...
    pricingGrid: [
      {
        size: "500 SQM",
        outright: "₦35,000,000",
        sixMonths: "₦49,000,000",
        twelveMonths: "₦63,000,000"
      },
      {
        size: "300 SQM",
        outright: "₦21,000,000",
